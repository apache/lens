...
public class GrillClientWrapperBean {

  private final GrillClientWrapper instance;

  public GrillClientWrapper getInstance() {
    return instance;
  }
  ...
  public GrillClientWrapperBean() {
    instance = GrillClientWrapper.INSTANCE;
  }
}
