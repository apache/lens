...
public class QueryServiceUIResource {
   ...
   * @param queryHandle The query handle
   * @return APIResult with state {@value org.apache.lens.api.APIResult.Status#SUCCEEDED} in case of successful cancellation.
   * APIResult with state {@value org.apache.lens.api.APIResult.Status#FAILED} in case of cancellation failure.
   */
  @DELETE
  @Path("queries/{queryHandle}")
  @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN})
