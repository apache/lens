...
@Description(
  name = "long_yoda_udf",
  value = "_FUNC_(str, ...) - Call Yoda UDF that returns value of Long type")
public class LongForwardingUDF extends UDF {
  ...
  public LongForwardingUDF() {
    udfObjects = new HashMap<String, Object>();
  }


  public Long evaluate(String yodaUdfName, Object ... udfArgs) throws HiveException {
